...
osascript -e 'display alert "Oops... You are not running the latest version of macOS" message "Please run this tool on a supported version of macOS." buttons {"Quit"}'
Input_On
echo ""
echo ""
echo ""
